...
- [ ] Rebuild components/pages in the order `SCREEN-AND-FEATURE-MAP.md` specifies — chunked into 5 groups (see [progress notes](progress/phase-5-gather-page.md) for the chunking): 1) gather page core ✅, 2) side menu/filters ✅ (see [progress notes](progress/phase-5-side-menu.md)), 3) settings page ✅ (see [progress notes](progress/phase-5-settings-page.md)), 4) search strings page ✅ (see [progress notes](progress/phase-5-search-strings-page.md)), 5) preset queries (highest complexity, last)
